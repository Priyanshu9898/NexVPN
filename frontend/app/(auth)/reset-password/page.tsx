    ...
    <div style={{ position: 'relative', width: 180, height: 180, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <path d="M12 8v4" stroke="var(--violet-2)" strokeWidth="1.5" strokeLinecap="round"/>
          <circle cx="12" cy="14" r="1" fill="var(--violet-2)"/>
        </svg>
      </div>
    </div>
  )
      ...
      >
        <div>
          ...
          <motion.p variants={leftItem} style={{ fontFamily: 'var(--font-manrope)', fontSize: '15px', color: 'var(--text-2)', marginTop: 16, maxWidth: 340, lineHeight: 1.6 }}>
            Set a strong new password to regain full access to your encrypted tunnel.
          </motion.p>
        </div>
    ...
    return (
      <div style={{ textAlign: 'center' }}>
        <div style={{
          ...
          <p style={{ fontFamily: 'var(--font-manrope)', fontSize: '14px', color: 'var(--rose)', margin: 0 }}>
            Invalid or missing reset token. Please request a new reset link.
          </p>
        </div>
        <Link href="/forgot-password" style={{ color: 'var(--violet)', fontFamily: 'var(--font-manrope)', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
          Request new link →
        </Link>
      </div>
    )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error((data as { message?: string }).message || 'Reset failed. The link may have expired.')
      }
      setSuccess(true)
        ...
        <motion.div variants={formItem}>
          ...
          <div style={{ position: 'relative' }}>
            <input
              ...
              style={{ ...inputBase, paddingRight: 44, ...(confirmFocus ? inputFocused : {}) }}
          ...
          {confirm.length > 0 && (
            <motion.span
              ...
              style={{
                ...
                color: password === confirm ? 'var(--emerald)' : 'var(--rose)',
              }}
            >
      ...
      <div style={{ display: 'flex', minHeight: '100dvh', background: 'var(--bg)' }}>
        ...
        <div style={{
          ...
          >
            ...
            <Suspense fallback={
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 0', color: 'var(--text-2)', fontFamily: 'var(--font-manrope)', fontSize: '14px' }}>
                Loading…
              </div>
            }>
              <ResetPasswordForm />
